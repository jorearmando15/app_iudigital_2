...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final VectorLibraryAccessors laccForVectorLibraryAccessors = new VectorLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>vector</b>
     */
    public VectorLibraryAccessors getVector() {
        return laccForVectorLibraryAccessors;
    }
    ...
    public static class VectorLibraryAccessors extends SubDependencyFactory {

        public VectorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>drawable</b> with <b>androidx.vectordrawable:vectordrawable</b> coordinates and
         * with version reference <b>vector.drawable</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDrawable() {
            return create("vector.drawable");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final VectorVersionAccessors vaccForVectorVersionAccessors = new VectorVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.vector</b>
         */
        public VectorVersionAccessors getVector() {
            return vaccForVectorVersionAccessors;
        }

    }

    public static class VectorVersionAccessors extends VersionFactory  {

        public VectorVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>vector.drawable</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDrawable() { return getVersion("vector.drawable"); }
